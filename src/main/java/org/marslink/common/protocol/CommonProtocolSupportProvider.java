...
import org.marslink.common.protocol.coap.CoAPDeviceMessageCodec;
import org.marslink.common.protocol.http.HttpDeviceMessageCodec;
import org.marslink.common.protocol.mqtt.MqttDeviceMessageCodec;
import org.marslink.common.protocol.tcp.DemoTcpMessageCodec;
import org.marslink.common.protocol.udp.DemoUdpMessageCodec;
import org.marslink.common.protocol.websocket.WebsocketDeviceMessageCodec;
...
public class CommonProtocolSupportProvider implements ProtocolSupportProvider {
    ...
    public Mono<? extends ProtocolSupport> create(ServiceContext context) {
        ...
        support.setId("marslink_common_protocol");
        support.setName("marslink通用协议");
        support.setDescription("marslink通用协议");
